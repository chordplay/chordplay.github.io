...
*/
  function openDetails(chordname, trtemp){
    $("<tr><td class='deeptree' id='" + chordname + "dim' draggable='true' ondragstart='dragChord(event)'> <p class='chordname basetrees'>"+chordname+"dim"+"</p> <img src='img/empty.png' srcset='img/empty@2x.png 2x, img/empty@3x.png 3x' class='sound basetrees'><img hidden src='img/sound.png' srcset='img/sound@2x.png 2x, img/sound@3x.png 3x' class='sound2 basetrees'> <img src='img/empty.png' srcset='img/empty@2x.png 2x, img/empty@3x.png 3x' class='dragaffordance basetrees'> <img hidden src='img/draggable.png' srcset='img/draggable@2x.png 2x, img/draggable@3x.png 3x' class='dragaffordance2 basetrees'></td></tr>").insertAfter(trtemp);
    $("<tr><td class='deeptree' id='" + chordname + "aug' draggable='true' ondragstart='dragChord(event)'> <p class='chordname basetrees'>"+chordname+"aug"+"</p> <img src='img/empty.png' srcset='img/empty@2x.png 2x, img/empty@3x.png 3x' class='sound basetrees'><img hidden src='img/sound.png' srcset='img/sound@2x.png 2x, img/sound@3x.png 3x' class='sound2 basetrees'> <img src='img/empty.png' srcset='img/empty@2x.png 2x, img/empty@3x.png 3x' class='dragaffordance basetrees'> <img hidden src='img/draggable.png' srcset='img/draggable@2x.png 2x, img/draggable@3x.png 3x' class='dragaffordance2 basetrees'></td></tr>").insertAfter(trtemp);
    $("<tr><td class='deeptree' id='" + chordname + "sus4' draggable='true' ondragstart='dragChord(event)'> <p class='chordname basetrees'>"+chordname+"sus4"+"</p> <img src='img/empty.png' srcset='img/empty@2x.png 2x, img/empty@3x.png 3x' class='sound basetrees'><img hidden src='img/sound.png' srcset='img/sound@2x.png 2x, img/sound@3x.png 3x' class='sound2 basetrees'> <img src='img/empty.png' srcset='img/empty@2x.png 2x, img/empty@3x.png 3x' class='dragaffordance basetrees'> <img hidden src='img/draggable.png' srcset='img/draggable@2x.png 2x, img/draggable@3x.png 3x' class='dragaffordance2 basetrees'></td></tr>").insertAfter(trtemp);
    $("<tr><td class='deeptree' id='" + chordname + "M7' draggable='true' ondragstart='dragChord(event)'> <p class='chordname basetrees'>"+chordname+"M7"+"</p> <img src='img/empty.png' srcset='img/empty@2x.png 2x, img/empty@3x.png 3x' class='sound basetrees'><img hidden src='img/sound.png' srcset='img/sound@2x.png 2x, img/sound@3x.png 3x' class='sound2 basetrees'> <img src='img/empty.png' srcset='img/empty@2x.png 2x, img/empty@3x.png 3x' class='dragaffordance basetrees'> <img hidden src='img/draggable.png' srcset='img/draggable@2x.png 2x, img/draggable@3x.png 3x' class='dragaffordance2 basetrees'></td></tr>").insertAfter(trtemp);
    $("<tr><td class='deeptree' id='" + chordname + "m7' draggable='true' ondragstart='dragChord(event)'> <p class='chordname basetrees'>"+chordname+"m7"+"</p> <img src='img/empty.png' srcset='img/empty@2x.png 2x, img/empty@3x.png 3x' class='sound basetrees'><img hidden src='img/sound.png' srcset='img/sound@2x.png 2x, img/sound@3x.png 3x' class='sound2 basetrees'> <img src='img/empty.png' srcset='img/empty@2x.png 2x, img/empty@3x.png 3x' class='dragaffordance basetrees'> <img hidden src='img/draggable.png' srcset='img/draggable@2x.png 2x, img/draggable@3x.png 3x' class='dragaffordance2 basetrees'> </td></tr>").insertAfter(trtemp);
    $("<tr><td class='deeptree' id='" + chordname + "7' draggable='true' ondragstart='dragChord(event)'> <p class='chordname basetrees'>"+chordname+"7"+"</p> <img src='img/empty.png' srcset='img/empty@2x.png 2x, img/empty@3x.png 3x' class='sound basetrees'><img hidden src='img/sound.png' srcset='img/sound@2x.png 2x, img/sound@3x.png 3x' class='sound2 basetrees'> <img src='img/empty.png' srcset='img/empty@2x.png 2x, img/empty@3x.png 3x' class='dragaffordance basetrees'> <img hidden src='img/draggable.png' srcset='img/draggable@2x.png 2x, img/draggable@3x.png 3x' class='dragaffordance2 basetrees'> </td></tr>").insertAfter(trtemp);
    $("<tr><td class='deeptree' id='" + chordname + "m' draggable='true' ondragstart='dragChord(event)'> <p class='chordname basetrees'>"+chordname+"m"+"</p> <img src='img/empty.png' srcset='img/empty@2x.png 2x, img/empty@3x.png 3x' class='sound basetrees'><img hidden src='img/sound.png' srcset='img/sound@2x.png 2x, img/sound@3x.png 3x' class='sound2 basetrees'> <img src='img/empty.png' srcset='img/empty@2x.png 2x, img/empty@3x.png 3x' class='dragaffordance basetrees'> <img hidden src='img/draggable.png' srcset='img/draggable@2x.png 2x, img/draggable@3x.png 3x' class='dragaffordance2 basetrees'> </td></tr>").insertAfter(trtemp);
